    ...
    AlertDialog(
        ...
        title = {
            Row(
                ...
                Text("Ambil Foto Produk", fontWeight = FontWeight.Bold, modifier = Modifier.weight(1f))
        ...
        text = {
            Column(
                ...
                if (!hasCameraPermission) {
                    Text(
                        text = "Izin kamera diperlukan untuk mengambil foto produk.",
                    ...
                    Box(
                        ...
                        IconButton(
                            onClick = {
                                ...
                                val photoFile = File(imagesDir, "prod_cam_${System.currentTimeMillis()}.jpg")
                            ...
                            Icon(
                                imageVector = Icons.Default.PhotoCamera,
                                contentDescription = "Jepret Foto",
                                tint = Color.White
                            )
                        }
                    }
